...
本仓库是安装文档、本机实验脚本、Helm 与运维技能的 **公开入口**。不含引擎源码。**签名 + SBOM：** 当前 `0.1.0` digest 按 [`docs/supply-chain.zh.md`](docs/supply-chain.zh.md) 校验。该 digest 之前的同名标签仍未签名。不要把 GHCR 当作 GA 供应链证明。
